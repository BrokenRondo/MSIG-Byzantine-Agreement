...
do
	...
	../build/bin/geth --exec 'eth.sendTransaction({from:"5b52a95f0f47f7b58a5b4c092d12ae8953838526", to:"c8d1bc936217e50d72b06b9dfc6d0006e8414d22", value: 100})' attach ipc:./data/node2/geth.ipc
done
