...
do
	...
	../build/bin/geth --exec 'eth.sendTransaction({from:"0x3ead0b0987220b828ec40c44ac23fbccfec9ffb4", to:"0xc8d1bc936217e50d72b06b9dfc6d0006e8414d22", value: 100})' attach ipc:./data/node4/geth.ipc
done
